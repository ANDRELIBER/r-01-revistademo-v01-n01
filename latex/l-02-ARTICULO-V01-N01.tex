...
\captionof{figure}{Fuente: elaboración propia.}
\vspace{\intextsep}
\end{figure}
...
\section{Formato 1: cita básica — normal}
...
\section{Formato 3: cita con localizador de página}
...
\section{Formato 6: múltiples citas en un bloque}
...
\section{Formato 7: múltiples con supresión parcial}
Hargittai y van Deursen \autocite{2565-HARGITTAI2002,2564-VANDEURSEN2019} coinciden en la importancia de las competencias digitales. El segundo autor ya fue mencionado en el párrafo anterior.


\section{Formato 8: prefijo textual con múltiples citas}
