...
\renewcommand{\articulotitulo}{Reseña de libro}
...
{\scriptsize\texttt{\href{mailto:hola@liber.com.ar}{hola@liber.com.ar}}}\par
...
\href{mailto:?subject=Rese%C3%B1a%20de%20libro&body=https%3A%2F%2Fwww.clacso.org%2Fciencia-tecnologia-y-sociedad-en-america-latina%2F}{\includesvg[height=0.9em]{/home/andrea/.gbpublisher/fonts/envelope}}~
...
\href{https://www.reddit.com/submit?url=https%3A%2F%2Fwww.clacso.org%2Fciencia-tecnologia-y-sociedad-en-america-latina%2F&title=Rese%C3%B1a%20de%20libro}{\includesvg[height=0.9em]{/home/andrea/.gbpublisher/fonts/reddit}}~
\href{https://www.researchgate.net/search?q=Rese%C3%B1a%20de%20libro}{\includesvg[height=0.9em]{/home/andrea/.gbpublisher/fonts/researchgate}}~
\href{https://t.me/share/url?url=https%3A%2F%2Fwww.clacso.org%2Fciencia-tecnologia-y-sociedad-en-america-latina%2F&text=Rese%C3%B1a%20de%20libro}{\includesvg[height=0.9em]{/home/andrea/.gbpublisher/fonts/telegram}}~
...
\href{https://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.clacso.org%2Fciencia-tecnologia-y-sociedad-en-america-latina%2F&text=Rese%C3%B1a%20de%20libro}{\includesvg[height=0.9em]{/home/andrea/.gbpublisher/fonts/x-twitter}}
}\par
\end{minipage}%
}% FIN GRUPO leftskip
\end{textblock*}
...
\sffamily\small \textbf{Resumen:} Este artículo presenta una reseña crítica del libro A elite do atraso: da escravidão à Lava Jato (2017), del sociólogo brasileño Jessé Souza. El texto examina la tesis central de la obra, la cual desplaza la noción tradicional de patrimonialismo como causa del atraso nacional para ubicar a la esclavitud y su legado como la verdadera matriz de la desigualdad en Brasil. Se analiza la revisión crítica que Souza realiza de pensadores canónicos como Freyre, Buarque de Holanda y Faoro, así como la introducción de la categoría sociológica de "ralé" para explicar la exclusión estructural. Finalmente, la reseña sopesa el valor del libro como una intervención intelectual urgente en el panorama político latinoamericano contemporáneo, señalando tanto sus aciertos polémicos como sus simplificaciones teóricas.
\par\smallskip\noindent\textbf{Palabras clave:} pensamiento social brasileño, esclavitud, desigualdad social, elites, sociología latinoamericana, reseña de libros
\end{otherlanguage}
\end{tcolorbox}

\begin{tcolorbox}[colback=brown!8!white,colframe=brown!8!white,boxrule=0pt,arc=2pt,left=4pt,right=4pt,top=3pt,bottom=3pt,before skip=4pt,after skip=4pt]
\begin{otherlanguage}{english}
\sffamily\small \textbf{Abstract:} This article presents a critical review of the book A elite do atraso: da escravidão à Lava Jato (2017), by Brazilian sociologist Jessé Souza. The text examines the core thesis of the work, which shifts the traditional notion of patrimonialism as the root of national backwardness to place slavery and its legacy as the true matrix of inequality in Brazil. It analyzes Souza's critical revision of canonical thinkers such as Freyre, Buarque de Holanda, and Faoro, alongside the introduction of the sociological category of the "ralé" (underclass) to explain structural exclusion. Finally, the review weighs the value of the book as an urgent intellectual intervention within the contemporary Latin American political landscape, noting both its polemical achievements and its theoretical simplifications.
\par\smallskip\noindent\textbf{Keywords:} Brazilian social thought, slavery, social inequality, elites, Latin American sociology, book reviews
\end{otherlanguage}
\end{tcolorbox}
